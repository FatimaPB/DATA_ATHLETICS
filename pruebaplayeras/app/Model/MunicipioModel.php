<?php
    class MunicipioModel{
        ...
        public function __construct(){
            ...
            $this->MunicipioConnection=new DBConnection();
        }
        ...
        public function getAll(){
            ...
            $connection =$this->MunicipioConnection->getConnection();
            ...
            $this->MunicipioConnection->closeConnection();
        ...
        public function getById($id){
            //creamos consulta
            $sql="CALL SP_GETMUNICIPIOBYID($id)";
        ...
        public function add($datosMUN){
            //paso1 creamos la consulta
            $sql="CALL SP_INSERTARCIUDAD('".$datosMUN['Ciudad']."','".$datosMUN['id_Estado']."');";
        ...
        public function update($datosMUN){
            //paso1 creamos la consulta
            $sql="CALL SP_ACTUALIZARCIUDAD('".$datosMUN['id_ciudad']."','".$datosMUN['Ciudad']."','".$datosMUN['id_Estado']."')";
            //paso 2 conectamos a la base de datos
            $connection =$this->MunicipioConnection->getConnection();
            //paso 3 ejecutamos la consulta
            $reslt = $connection->query($sql);
