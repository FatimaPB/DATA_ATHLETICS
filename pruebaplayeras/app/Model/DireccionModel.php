<?php
    class DireccionModel{
        ...
        public function __construct(){
            ...
            $this->DireccionConnection=new DBConnection();
        }
        ...
        public function getAll(){
            ...
            $sql="CALL SP_CONSULTADIRECCION()";
            //paso 2 obtengo la coneccion a la base de datos 
            $connection =$this->DireccionConnection->getConnection();
            ...
            $this->DireccionConnection->closeConnection();
        ...
        public function getById($id){
            //creamos consulta
            $sql="CALL SP_GETDIRECCIONBYID($id)";
        ...
        public function add($datosDIR){
            //paso1 creamos la consulta
            $sql="CALL SP_INSERTARDIRECCION('".$datosDIR['Direccion']."','".$datosDIR['id_Colonia']."','".$datosDIR['costo']."');";
        ...
        public function update($datosDIR){
            //paso1 creamos la consulta
            $sql="CALL SP_ACTUALIZARDIRECCION('".$datosDIR['id_direccion']."','".$datosDIR['Direccion']."','".$datosDIR['id_Colonia']."','".$datosDIR['costo']."')";
            //paso 2 conectamos a la base de datos
            $connection =$this->DireccionConnection->getConnection();
            //paso 3 ejecutamos la consulta
            $reslt = $connection->query($sql);
